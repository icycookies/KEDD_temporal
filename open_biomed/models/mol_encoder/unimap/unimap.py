...
from models.mol_encoder.unimap.gcn import DeeperGCN, AtomHead
from models.mol_encoder.unimap.modeling_roberta import RobertaLayer, RobertaModel
...
if __name__ == "__main__":
    ...
    from feat.mol_featurizer import MolMultiScaleFeaturizer
